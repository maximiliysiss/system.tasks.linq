...
/// <summary>
/// Provides <c>AsEnumerable</c> for <c>Task&lt;IList&lt;T&gt;&gt;</c>, widening it to
/// <c>Task&lt;IEnumerable&lt;T&gt;&gt;</c> so that all LINQ extension methods become available.
/// </summary>
public static class IListExtensions
{
    /// <summary>
    /// Awaits the task and returns the resulting <see cref="IList{TSource}"/> as an <see cref="IEnumerable{TSource}"/>.
    /// </summary>
